function start() {
    ...
    /* Verificando se o usuário pressionou uma tecla */
    ...
    /* Função que detecta todas as colisões do jogo */
    function colisao() {
        ...
        /* Colisão do jogador com o inimigo 1 */
        ...
        /* Colisão do jogador com o inimigo 2 */
        ...
        /* Colisão do amigo com o jogador */
        ...
        /* Função que detecta todas as colisões do inimigo 2 e executa a explosão */
    ...
    /* Função que detecta todas as colisões do inimigo 1 e executa a explosão */
    ...
    /* Função que reposiciona o inimigo 2 */
    ...
    /* Função que detecta todas as colisões do amigo e executa a morte */
    ...
    /* Função que mostra o placar do jogo */
    function placar() {
        $("#placar").html("<h2> Pontos: " + pontos + " Salvos: " + salvos + " Perdidos: " + perdidos + "</h2>");
    } 


    /* Função que mostra a barra de energia */
    function energia() {
        if (energiaAtual == 3) {
